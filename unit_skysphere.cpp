...
bool UnitSkysphere::init(std::shared_ptr<Graphics> graphics)
{
...
void UnitSkysphere::prepareForRender(std::shared_ptr<Graphics>)
{
}

void UnitSkysphere::render(std::shared_ptr<Graphics> graphics)
{
    // render skybox
...
void UnitSkysphere::cleanup(std::shared_ptr<Graphics>)
{
    skyboxPrim->cleanup();
